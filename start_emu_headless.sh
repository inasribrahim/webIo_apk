...
function launch_emulator () {
  ...
  options="@${emulator_name} -no-window -no-snapshot -screen no-touch -noaudio -memory 12000 -cores 12 -no-boot-anim -accel off -camera-back none swiftshader_indirect"
